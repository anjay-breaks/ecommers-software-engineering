...
Route::post('/place-an-order',[CartController::class,'place_on_order'])->name('cart.place.on.order');
Route::get('/order-confirmation',[CartController::class,'order_confirm'])->name('cart.order.confirmation');
...
Route::post('/profile/upload-photo', [UserController::class, 'uploadPhoto'])->name('profile.upload');
...
Route::middleware(['auth',AuthAdmin::class])->group(function(){
    ...
    Route::get('/admin/products/add', [AdminController::class, 'products_add'])->name('admin.product.add');
    Route::post('/admin/products/store', [AdminController::class, 'products_store'])->name('admin.product.store');
